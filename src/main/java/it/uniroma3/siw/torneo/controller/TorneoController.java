...
public class TorneoController {
	...
	public String formNuovoTorneo(Model model) {
		...
		return "formNuovoTorneo.html";
	}
	
	/**
	 * Metodo POST che riceve i dati inviati dal form html e li salva
	 * @param torneo, L'oggetto creato da Spring unendo i dati che l'utente ha messo nel form
	 * @param model, Il Model per passare eventuali messaggi alla vista successiva
	 * @return redirect che riporta alla pagina della lista tornei dopo aver effettuato il salvataggio */
